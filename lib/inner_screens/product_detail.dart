...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final productAttribute = productData.getById(productId);
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _details(themeState.darkTheme, 'Brand: ', productAttribute.brand),
                      _details(themeState.darkTheme, 'Quantity: ', '${productAttribute.quantity} Left'),
                      _details(themeState.darkTheme, 'Category: ', productAttribute.productCategoryName),
                      _details(themeState.darkTheme, 'Popularity: ', productAttribute.isPopular?'Popular':'Not Popular'),
                      SizedBox(
                        height: 15,
                      ),
                      Divider(
                  ...
                  child: Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        ...
                        cartProvider.addProductToCart(productId, productAttribute.title, productAttribute.price, productAttribute.imageUrl);
                      },
                      child: Text(
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        favsProvider.addAndRemoveFromFavs(productId, productAttribute.title, productAttribute.price, productAttribute.imageUrl);
                      },
                      child: Center(
                        child: Icon(
                          favsProvider.getFavsItems.containsKey(productId)?MyAppIcons.wishlist:MyAppIcons.unWishlist,
