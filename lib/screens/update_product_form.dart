...
class UpdateProductForm extends StatefulWidget {
  static const routeName = '/UpdateProductForm';
...
class _UpdateProductFormState extends State<UpdateProductForm> {
    ...
    if (isValid) {
      ...
      if(localImage.isNotEmpty){
        if(localImage==''||localImage == null){
          ...
          FirebaseFirestore.instance.collection('products').doc(productUpdateId).set({
  ...
  Widget build(BuildContext context) {
    ...
    _categoryController.text= productAttribute.productCategoryName;
    _brandController.text = productAttribute.brand;
    productUpdateId = productId;
    url = productAttribute.imageUrl;
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                          ...
                          children: [
                            Flexible(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  initialValue: productAttribute.title,
                                  key: ValueKey('Title'),
                                  validator: (value) {
                                    if (value!.isEmpty) {
                            ...
                            Flexible(
                              flex: 1,
                              child: TextFormField(
                                initialValue: productAttribute.price.toString(),
                                key: ValueKey('Price \$'),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  child: TextFormField(
                                    ...
                                    // initialValue: productAttribute.brand??'',
                                    key: ValueKey('Brand'),
                                    validator: (value) {
                                      if (value!.isEmpty) {
                        ...
                        TextFormField(
                            ...
                            initialValue: productAttribute.description,
                            validator: (value) {
                              if (value!.isEmpty) {
                          ...
                          children: [
                            Expanded(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(right: 9),
                                child: TextFormField(
                                  initialValue: productAttribute.quantity.toString(),
                                  keyboardType: TextInputType.number,
