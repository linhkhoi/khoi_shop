...
class Products with ChangeNotifier{
  ...
  List<Product> findByCategory(String categoryName){
    return _products.where((element) => element.productCategoryName.toLowerCase().contains(categoryName.toLowerCase())).toList();
  }

  List<Product> findByBrand(String brandName){
    return _products.where((element) => element.brand.toLowerCase().contains(brandName.toLowerCase())).toList();
  }
...
/*
 List<Product> _products = [
    Product(
        ...
        quantity: 65,
        isPopular: false, isFavorite: true),
    Product(
